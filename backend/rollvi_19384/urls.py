"""rollvi_19384 URL Configuration
...
admin.site.site_header = "Rollvi"
admin.site.site_title = "Rollvi Admin Portal"
admin.site.index_title = "Rollvi Admin"

# swagger
api_info = openapi.Info(
    title="Rollvi API",
    default_version="v1",
    description="API documentation for Rollvi App",
)
